...
-- for bi-monthly refresh the offset should be -2 as we want the data for the latest 3 months (previous 2 months final and current performance month)

WHERE UsePathway_Flag = 'True' 
	AND l.[ReportingPeriodStartDate] BETWEEN DATEADD(MONTH, -2, @PeriodStart) AND @PeriodStart	
