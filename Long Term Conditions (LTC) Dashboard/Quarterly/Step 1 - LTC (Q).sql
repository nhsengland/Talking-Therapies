...
FROM	[mesh_IAPT].[IDS101referral] r
	...
	-- for quarterly refresh the offset should be -3 as we want the data for the latest 4 months (previous 3 months final and current performance month)

WHERE	r.UsePathway_Flag = 'True' AND l.IsLatest = 1
	AND l.[ReportingPeriodStartDate] BETWEEN DATEADD(MONTH, -3, @Period_Start) AND @Period_Start -- Set to -3 for quarterly refresh
